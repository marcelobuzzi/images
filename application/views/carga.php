<div class="row w-100 mx-0 my-3 px-0 py-3 border-bottom">
  <div class="col-12 w-100 m-0 p-0 text-center">
    ...
    <div class="row m-0 p-0 w-100">
      <div class="col-12 w-100 m-0 p-0">
        <form id="frmImagen" enctype="multipart/form-data" >
          ...
          <input id='grados'    name="grados"     class="d-none" type="hidden" value="">
        </form>
      </div>
    </div>
    <br>
    <div class="row m-0 p-0 w-100">
      <div class="col-12 w-100 m-0 p-0">
        <button class="btn btn-primary" type="button" name="button" onclick="guardar('<?=base_url('guardarImagen');?>', 'frmImagen');"><i class="far fa-save"></i></button>
...
<script type="text/javascript">
  ...
  function rotate(imagen, grados) {
    ...
    $('#grados').val(anguloGrados + grados);
  }
